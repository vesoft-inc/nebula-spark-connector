...
class WriteNebulaVertexConfig(space: String,
                              ...
                              overwrite: Boolean,
                              disableWriteLog: Boolean)
  extends WriteNebulaConfig(space, user, passwd, batch, writeMode, overwrite, disableWriteLog) {
...
object WriteNebulaVertexConfig {
  ...
  class WriteVertexConfigBuilder {
    ...
    var disableWriteLog: Boolean = true
    ...
    /**
     * set whether disable the write log for failed data
     */
