...
[中文版](https://github.com/vesoft-inc/nebula-spark-connector/blob/v2.5/README_CN.md)
...
1. Package Nebula Spark Connector 2.0.
    ...
    After the packaging, you can see the newly generated nebula-spark-connector-2.5.1.jar under the nebula-spark-connector/nebula-spark-connector/target/ directory.
...
* Nebula Spark Connector 2.5.0 support DELETE write mode to NebulaGraph, see [Delete Vertex](https://docs.nebula-graph.io/2.5.1/3.ngql-guide/12.vertex-statements/4.delete-vertex/)
